function [results] = dsge_backward_errors_condition_partial(inputs)
...
min_svd_F=svds(F,1,'smallest')^2;
min_svd_A=svds(A,1,'smallest')^2; 
 results(10,1)=(1/(min_svd_F+min_svd_P*min_svd_A)^(1/2))*(alpha*P_2_F+beta*P_F+gamma)/P_F;
end
